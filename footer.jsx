    ...
    <div className="container-xxl">
      <div className="row justify-content-center justify-content-md-start">
        <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
          ...
          <div className='mb-3'><p><b>Address:</b>  Kutaisi, Georgia</p> </div>
          <div className='mb-3'><p><b>Phone:</b>  <a className='footer-tel' href="tel:+995599555">Call us at +995599559</a></p> </div>
          ...
          <Link to={'https://github.com/NaniChkhenkeli'} className='gap-3' id='footer-link'>
          <BsGithub />
          </Link>
      ...
      <div className="row">
        ...
        <p className="text-center text-md-start">&copy;Developed by CS Student</p>
        </div>
        <div className="col-12 col-md-6">
