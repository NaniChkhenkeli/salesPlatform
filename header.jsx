...
const header = () => {
  ...
  <button className="btn btn-outline-dark me-2">☀️Light Mode</button>
  <button className="btn btn-outline-dark">🌐 EN </button>
</div>


          <div className="col-md">
  <Link className='links fs-4'><CiMail className="icon-small" /></Link>
  <Link className='links fs-4'><BiPhoneCall className="icon-small" /></Link>
  <a href="https://www.facebook.com/login" target="_blank" rel="noopener noreferrer" className='links fs-4'><FaFacebook className="icon-small" /></a>
  <a href="https://www.instagram.com/accounts/login/" target="_blank" rel="noopener noreferrer" className='links fs-4'><FaInstagram className="icon-small" /></a>
  <a href="https://twitter.com/login" target="_blank" rel="noopener noreferrer" className='links fs-4'><FaTwitter className="icon-small" /></a>
</div>
